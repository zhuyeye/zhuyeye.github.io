...
document.getElementById('shareButton').addEventListener('click', async () => {
  try {
    if (navigator.share) {
      await navigator.share({ title: document.title, text: '2026国庆景德镇、三清山、杭州行程攻略', url: window.location.href });
    } else {
